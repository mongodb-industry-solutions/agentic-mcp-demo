...
_SYSTEM_PROMPT = (
    ...
    "pcrf_from/pcrf_to, roaming_enable countries, markets (pass "
    "canonical ids like 'NYC_Metro'/'LA_Metro' when you know them; "
    "city hints like 'LA' are resolved server-side), time_windows "
    "('Saturday evening' → 'Saturday_20_23'), and "
